...
//	static void noti_fier(WorkerMonitor *monitor, const std::string& msg)
//	{
//		std::cout << "LOG: notifier message = " << msg << std::endl;
//
//		monitor->Notify(msg);
//	}
	...
	void WorkerMonitor::Notify(const std::string& msg)
	{
	...
	{
		//const WorkerMonitor& self = *this;

		//const std::function<void(const std::string&)>& notifierFunc = std::bind(&noti_fier, this, std::placeholders::_1);
